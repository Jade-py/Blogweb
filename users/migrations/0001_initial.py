    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college_name', models.TextField(default='Not Specified', max_length=250)),
                ('stream', models.TextField(default='Not Specified', max_length=100)),
                ('graduation_year', models.IntegerField(default=0)),
                ('phone_no', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None, verbose_name='IN')),
